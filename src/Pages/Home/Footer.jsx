  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.kaggle.com/nabiladouma"
              ...
              >
                <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M6.18 0C5.48 0 4.89 0.51 4.89 1.14V4.93H1.14C0.51 4.93 0 5.43 0 6.06V9.93C0 10.56 0.51 11.06 1.14 11.06H4.89V27.86C4.89 28.49 5.48 29 6.18 29H9.92C10.63 29 11.22 28.49 11.22 27.86V11.06H14.97C15.68 11.06 16.27 10.56 16.27 9.93V6.06C16.27 5.43 15.68 4.93 14.97 4.93H11.22V1.14C11.22 0.51 10.63 0 9.92 0H6.18Z"
                      fill="currentColor"
                    />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://huggingface.co/nabilaa123"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://github.com/NABILA2123"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/nabila-douma-711b77291/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with love</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
